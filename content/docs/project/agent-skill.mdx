...
For exact SDK calls, see [sending events](/start/sending-events) and the [SDK reference](/reference/sdk). For backend events, see the [API reference](/reference/api).
