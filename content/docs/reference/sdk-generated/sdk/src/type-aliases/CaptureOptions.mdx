...
[SDK and React Reference](../../../) / [sdk/src](../) / CaptureOptions
...
Per-event options accepted by [ClickHouseProductAnalytics.capture](../classes/ClickHouseProductAnalytics/#capture).

## Properties

### $set?

> `optional` **$set?**: [`CaptureProperties`](CaptureProperties/)
...
> `optional` **$set\_once?**: [`CaptureProperties`](CaptureProperties/)
