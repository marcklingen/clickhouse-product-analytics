...
[SDK and React Reference](../../../index.mdx) / [sdk/src](../index.mdx) / CaptureOptions
...
Per-event options accepted by [ClickHouseProductAnalytics.capture](../classes/ClickHouseProductAnalytics.mdx#capture).

## Properties

### $set?

> `optional` **$set?**: [`CaptureProperties`](CaptureProperties.mdx)
...
> `optional` **$set\_once?**: [`CaptureProperties`](CaptureProperties.mdx)
