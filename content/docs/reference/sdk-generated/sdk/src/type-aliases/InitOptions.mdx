...
[SDK and React Reference](../../../) / [sdk/src](../) / InitOptions
...
> `optional` **autocapture?**: `boolean` \| [`AutocaptureConfig`](AutocaptureConfig/)
...
> `optional` **beforeSend?**: [`BeforeSendHook`](BeforeSendHook/) \| [`BeforeSendHook`](BeforeSendHook/)[]
