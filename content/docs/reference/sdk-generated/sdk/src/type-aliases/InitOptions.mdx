...
[SDK and React Reference](../../../index.mdx) / [sdk/src](../index.mdx) / InitOptions
...
> `optional` **autocapture?**: `boolean` \| [`AutocaptureConfig`](AutocaptureConfig.mdx)
...
> `optional` **beforeSend?**: [`BeforeSendHook`](BeforeSendHook.mdx) \| [`BeforeSendHook`](BeforeSendHook.mdx)[]
...
> `optional` **transport?**: [`Transport`](Transport.mdx)
