...
```text
Web app / React app  ->  Browser SDK  ->  HTTP ingest service  ->  ClickHouse
...
For agentic analytics, prefer narrow SQL queries over exporting tables. See [ClickHouse schema](./clickhouse-schema.md) for column-level details and query patterns.
